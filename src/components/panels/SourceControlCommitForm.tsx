	...
	return (
		<div className="border-t border-border px-3 py-2 shrink-0 flex flex-col gap-1.5">
			...
			<div className="flex items-center gap-1.5">
				...
				<button
					type="button"
					className="flex items-center justify-center gap-1 border border-border rounded px-2 py-1 text-xs font-medium hover:bg-foreground/5 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
					disabled={loading}
					onClick={onPush}
				>
					{pushing ? (
