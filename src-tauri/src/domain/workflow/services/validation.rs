...
fn validate_node_type_fields(step: &NodeDefinition) -> Result<(), ValidationError> {
...
mod tests {
    use super::*;
    use crate::domain::workflow::{
        ChildNodeDefinition, CollectConfig, CycleGuard, ParallelAggregate,
    };
    ...
    impl IntoNamed for NodeDefinition {
