...
pub use value_objects::{
    ...
    NodeFactRecord, NodeHistoryEntry, NodeKind, NodeKindName, OnFailure, Predicate,
    ProcessExitedFact, ProviderSessionTitleObservedFact, RepositoryWorktreeInventory, Rule,
