...
fn test_失敗分類_usecase_全変種と委譲した理由を保持する() {
    ...
    let cases = [
        ...
        (ProviderLifecycleIngressUsecaseError::Corrupt, F::Corrupt),
        (
            ProviderLifecycleIngressUsecaseError::Store(F::Temporary),
            F::Temporary,
        ),
        (
            ProviderLifecycleIngressUsecaseError::Store(F::RestartRequired),
            F::RestartRequired,
        ),
        (
            ProviderLifecycleIngressUsecaseError::Store(F::StateRequired),
            F::StateRequired,
        ),
        (
            ProviderLifecycleIngressUsecaseError::Store(F::InvalidInput),
            F::InvalidInput,
        ),
        (
            ProviderLifecycleIngressUsecaseError::Store(F::Expired),
            F::Expired,
        ),
        (
            ProviderLifecycleIngressUsecaseError::Store(F::Missing),
            F::Missing,
        ),
        (
            ProviderLifecycleIngressUsecaseError::Store(F::AlreadyPresent),
            F::AlreadyPresent,
        ),
        (
            ProviderLifecycleIngressUsecaseError::Store(F::Permission),
            F::Permission,
        ),
        (
            ProviderLifecycleIngressUsecaseError::Store(F::Capacity),
            F::Capacity,
        ),
        (
            ProviderLifecycleIngressUsecaseError::Store(F::Unsupported),
            F::Unsupported,
        ),
        (
            ProviderLifecycleIngressUsecaseError::Store(F::Internal),
            F::Internal,
        ),
        (
            ProviderLifecycleIngressUsecaseError::Store(F::Corrupt),
            F::Corrupt,
        ),
        (
            ProviderLifecycleIngressUsecaseError::Store(F::Cancelled),
            F::Cancelled,
        ),
        (
            ProviderLifecycleIngressUsecaseError::Store(F::Unknown),
            F::Unknown,
        ),
        (
            ProviderLifecycleIngressUsecaseError::Store(F::OutsideRange),
            F::OutsideRange,
        ),
        (
            ProviderLifecycleIngressUsecaseError::Store(F::AuthenticationRequired),
