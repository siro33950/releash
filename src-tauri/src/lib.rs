...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            adaptor::controller::command::agent_session::session::build_agent_copy_response,
            adaptor::controller::command::agent_session::session::write_agent_copy_selection_to_file,
            adaptor::controller::command::agent_session::session::build_agent_export_transcript,
            adaptor::controller::command::agent_session::session::build_agent_task_list_report,
            adaptor::controller::command::agent_session::session::compact_agent_context,
            adaptor::controller::command::agent_session::session::clean_codex_background_terminals,
            adaptor::controller::command::agent_session::session::run_codex_shell_command,
            adaptor::controller::command::agent_session::session::start_codex_realtime_text_session,
            adaptor::controller::command::agent_session::session::append_codex_realtime_text,
            adaptor::controller::command::agent_session::session::stop_codex_realtime_session,
            adaptor::controller::command::agent_session::session::start_codex_uncommitted_changes_review,
            adaptor::controller::command::agent_session::session::read_codex_thread_goal,
            adaptor::controller::command::agent_session::session::set_codex_thread_goal,
            adaptor::controller::command::agent_session::session::clear_codex_thread_goal,
            adaptor::controller::command::agent_session::session::read_codex_account_status,
            adaptor::controller::command::agent_session::session::read_codex_thread_history_report,
            adaptor::controller::command::agent_session::session::read_codex_thread_transcript_report,
            adaptor::controller::command::agent_session::session::read_codex_realtime_voices_report,
            adaptor::controller::command::agent_session::session::read_codex_runtime_config_report,
            adaptor::controller::command::agent_session::session::read_codex_runtime_capabilities_report,
            adaptor::controller::command::agent_session::session::read_codex_hooks_report,
            adaptor::controller::command::agent_session::session::read_codex_mcp_status_report,
            adaptor::controller::command::agent_session::session::read_codex_permission_profiles,
            adaptor::controller::command::agent_session::session::read_codex_permission_profiles_report,
            ...
            adaptor::controller::command::agent_session::model::set_codex_permission_profile,
            ...
            adaptor::controller::command::agent_session::dictation::present_agent_dictation,
            adaptor::controller::command::agent_session::dictation::compose_agent_dictation_draft,
            ...
            adaptor::controller::command::agent_session::action::build_agent_debug_config_report,
            adaptor::controller::command::agent_session::action::build_agent_doctor_report,
            adaptor::controller::command::agent_session::action::create_agents_md_scaffold,
            ...
            session_commands::rewind_session_to_message,
            session_commands::fork_session,
            session_commands::set_session_title,
            session_commands::get_rewind_worktree_checkpoint_preview,
            session_commands::restore_session_worktree_checkpoint,
