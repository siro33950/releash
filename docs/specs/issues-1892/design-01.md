...
- batch の大きさ上限の値（`MAX_BATCH_EVENTS` 4096 / `MAX_BATCH_STATE_MUTATIONS` 8192 / `MAX_BATCH_DECODED_BYTES` 16 MiB）。4 か所に分かれた判定を 1 か所へ寄せるだけとする。
